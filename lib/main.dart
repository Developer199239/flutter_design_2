  ...
  return Stack(
    children: [
      Positioned(
        left: 20,
        right: 20,
        top: 100, // Adjusted to give space for the profile image
        child: Card(
...
Positioned roundProfileImage() {
  return Positioned(
    left: 0,
    right: 0,
    top: 50, // Adjusted the top position to align with the floating card
    child: Center(
      child: Container(
...
Padding socialMediaStackSection(){
